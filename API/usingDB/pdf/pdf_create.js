...
function generateHeader(doc) {
  doc
    .fillColor("#444444")
    .fontSize(20)
    .text("B&M Sausages Ltd", 110, 57)
    .fontSize(10)
    .text("B&M Sausages Ltd", 200, 50, { align: "right" })
    .text("292-294 Glentanar Rd", 200, 65, { align: "right" })
    .text("G22 7XS Glasgow", 200, 80, { align: "right" })
    .moveDown();
}
